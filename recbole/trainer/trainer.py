...
class Trainer(AbstractTrainer):
    ...
    def _valid_epoch(self, valid_data):
        ...
        Returns:
            ...
            dict: valid result
        """
        valid_result, _ = self.evaluate(valid_data, load_best_model=False)
    ...
    def fit(self, train_data, valid_data=None, verbose=True, saved=True):
        ...
        for epoch_idx in range(self.start_epoch, self.epochs):
            ...
            training_epoch_time.append(training_end_time-training_start_time)
            if verbose:
            ...
            if (epoch_idx + 1) % self.eval_step == 0:
                ...
                ndcg_result.append(valid_result['ndcg@10'])
                if verbose:
                ...
                if stop_flag:
                    ...
                    break
        avg_time = np.array(training_epoch_time).mean()
        f_out = open('ndcg_result.txt', 'w')
        for i in ndcg_result:
            f_out.write(str(i)+'\n')
        f_out.close()
        return self.best_valid_score, self.best_valid_result, avg_time
    ...
    def evaluate(self, eval_data, load_best_model=True, model_file=None):
        ...
        test_end_time = time()
        return result, test_end_time-test_start_time
